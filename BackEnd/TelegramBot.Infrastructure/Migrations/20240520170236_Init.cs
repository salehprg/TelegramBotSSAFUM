        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    MainChannelUsername = table.Column<string>(type: "text", nullable: false),
                    MainGroupUsername = table.Column<string>(type: "text", nullable: false),
                    DelayBetweenPosts = table.Column<float>(type: "real", nullable: false),
                    ReminderPostDelay = table.Column<TimeSpan>(type: "interval", nullable: false),
                    ReminderAccountDelay = table.Column<TimeSpan>(type: "interval", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForwardDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    TelegramId_PostId = table.Column<int>(type: "integer", nullable: false),
                    PostStatus = table.Column<int>(type: "integer", nullable: false),
                    channelInfoId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
